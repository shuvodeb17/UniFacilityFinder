...
const AdmissionForm = () => {
    ...
    const onSubmit = data => {
        ...
        const insertData = { studentName: data.studentName, studentEmail: data.studentEmail, studentPhoneNumber: data.studentPhoneNumber, admittedCollegeName: data.admittedCollegeName, dateOfBirth: data.dateOfBirth }
